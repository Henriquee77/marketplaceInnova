...
SECRET_KEY = 'django-insecure-(zm2e@olc^7s)tjyj+!67^oln!vss4!&&(%c%7_6(^2^-$m&i%'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [BASE_DIR / 'static']  # Diretório estático configurado
...
LOGIN_REDIRECT_URL = '/home/'  # URL para redirecionar após login bem-sucedido
